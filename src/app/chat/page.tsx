...
const mockMessages: Message[] = [
	{
		...
		role: "user",
		content:
			"Explain the process of photosynthesis and how it relates to cellular respiration.",
		timestamp: "2:30 PM",
	},
	{
		id: "2",
	...
	return (
		<div className="flex items-start gap-3 rounded-lg border bg-muted/50 p-3">
			...
			<div className="min-w-0 flex-1">
				<p className="font-medium text-foreground text-sm">{reference.title}</p>
				<p className="text-muted-foreground text-xs">{reference.page}</p>
					...
					<div className="mt-3">
						...
						<div className="flex flex-col gap-2">
							{message.references.map((ref, i) => (
								<ReferenceCard key={"v" + i} reference={ref} />
							))}
						</div>
					</div>
				)}
