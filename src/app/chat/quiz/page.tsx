...
const mockQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ["Thylakoid membrane", "Cytoplasm", "Stroma", "Mitochondrial matrix"],
    correctIndex: 2,
    explanation:
  ...
  {
    id: "3",
    question: "Which molecule is the final electron acceptor in the light reactions?",
...
export default function QuizPage() {
  ...
  const progress = ((currentIndex + (showExplanation ? 1 : 0)) / mockQuestions.length) * 100
          ...
          {!quizStarted ? (
            ...
            <div className="flex flex-col items-center pt-12 text-center">
              ...
              <p className="mt-2 max-w-md text-sm text-muted-foreground">
                AI will generate questions from your uploaded curriculum materials. Choose a topic and difficulty to get started.
              </p>
            ...
            <div className="flex flex-col items-center pt-12 text-center">
              ...
              <div className="mt-6 w-full max-w-xs">
                <Progress value={(score / mockQuestions.length) * 100} className="h-3" />
            ...
            <div>
              ...
              <h3 className="mt-2 text-lg font-semibold text-foreground leading-relaxed">
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        !showResult && "hover:border-foreground/20 hover:bg-muted/50",
                        !showResult && isSelected && "border-foreground/30 bg-muted/50",
                        showResult && isCorrect && "border-accent bg-accent/10 text-foreground",
                        showResult && isSelected && !isCorrect && "border-destructive bg-destructive/5 text-foreground",
                        showResult && !isSelected && !isCorrect && "opacity-50"
                      )}
                    >
                      <span className="flex size-7 shrink-0 items-center justify-center rounded-full border text-xs font-medium">
              ...
              {showExplanation && (
                <div className="mt-6 rounded-xl border bg-muted/30 p-4">
                  ...
                  <Button className="mt-4" onClick={handleNext}>
                    {currentIndex < mockQuestions.length - 1 ? "Next Question" : "See Results"}
                    <ChevronRight className="size-4" />
                  </Button>
                </div>
              )}
