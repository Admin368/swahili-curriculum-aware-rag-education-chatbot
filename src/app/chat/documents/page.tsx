...
export default function DocumentsPage() {
	...
	return (
		<div className="flex h-full flex-col">
				...
				<Dialog onOpenChange={setUploadOpen} open={uploadOpen}>
					...
					<DialogContent>
						<DialogHeader>
							...
							<DialogDescription>
								Upload course materials to be chunked and vectorized for RAG
								retrieval.
							</DialogDescription>
						</DialogHeader>
						...
						<div className="flex flex-col gap-3">
							<div className="flex flex-col gap-2">
								...
								<Select defaultValue="semantic">
									...
									<SelectContent>
										...
										<SelectItem value="fixed-256">
											Fixed Size (256 tokens)
										</SelectItem>
										<SelectItem value="fixed-512">
											Fixed Size (512 tokens)
										</SelectItem>
										<SelectItem value="fixed-1024">
											Fixed Size (1024 tokens)
										</SelectItem>
							...
							<div className="flex flex-col gap-2">
								...
								<Select defaultValue="text-3-small">
									...
									<SelectContent>
										<SelectItem value="text-3-small">
											text-embedding-3-small
										</SelectItem>
										<SelectItem value="text-3-large">
						...
						<DialogFooter>
							<Button onClick={() => setUploadOpen(false)} variant="outline">
								Cancel
							</Button>
			...
			{/* Detail Dialog */}
			<Dialog onOpenChange={() => setDetailDoc(null)} open={!!detailDoc}>
				<DialogContent>
					<DialogHeader>
					...
					<DialogFooter>
						<Button onClick={() => setDetailDoc(null)} variant="outline">
							Close
						</Button>
					</DialogFooter>
				</DialogContent>
